...
<head>
	<title>Science</title>
	<meta charset="utf-8">
	<link rel="stylesheet" href="assets/oxima/css/reset.css" type="text/css" media="all">
	<link rel="stylesheet" href="assets/oxima/css/layout.css" type="text/css" media="all">
	<link rel="stylesheet" href="assets/oxima/css/style.css" type="text/css" media="all">
	<script type="text/javascript" src="assets/oxima/js/jquery-1.4.2.js" ></script>
	<script type="text/javascript" src="assets/oxima/js/cufon-yui.js"></script>
	<script type="text/javascript" src="assets/oxima/js/cufon-replace.js"></script>
	<script type="text/javascript" src="assets/oxima/js/Myriad_Pro_300.font.js"></script>
	<script type="text/javascript" src="assets/oxima/js/Myriad_Pro_400.font.js"></script>
	<!--[if lt IE 9]>
	<script type="text/javascript" src="assets/oxima/js/ie6_script_other.js"></script>
	<script type="text/javascript" src="assets/oxima/js/html5.js"></script>
	<![endif]-->
</head>
<body id="page1">
<!-- START PAGE SOURCE -->
